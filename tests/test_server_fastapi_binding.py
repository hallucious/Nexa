...
def test_fastapi_binding_workspace_shell_route_round_trip() -> None:
    ...
    assert payload['return_use_continuity_section']['controls'][0]['action_target'] == '/app/workspaces/ws-001/library?app_language=en'
    ...
    assert payload['product_surface_review_section']['controls'][0]['action_target'] == '/app/workspaces/ws-001/library?app_language=en'
