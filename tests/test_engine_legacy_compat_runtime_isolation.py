...
def test_engine_cli_keeps_legacy_nex_execution_inline_but_moves_loader_and_adapter_out() -> None:
    ...
    assert "from src.circuit.loader import load_legacy_nex_bundle, load_legacy_nex_file" in cli_source
    assert "from src.circuit.runtime_adapter import build_engine_from_legacy_nex" in cli_source
...
def test_legacy_nex_engine_adaptation_moves_to_runtime_adapter() -> None:
