...
* referential post-commit requests now have a minimal action-resolution policy: safe revert / undo / rollback patterns may auto-resolve into bounded revert actions, while mixed-action requests remain confirmation-bounded
