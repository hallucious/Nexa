...
Nexa should keep `.nex` as the main structured document family.
...
Nexa keeps `.nex` as the main artifact family, distinguished internally by explicit `storage_role`.
