# Review Resolution / Issue Lifecycle Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/28_review_resolution_issue_lifecycle_contract.md`

## 1. Purpose

This document fixes the operational contract for issue lifecycle inside the Nexa shell.
...
## 8. Three workflow objects

- comment = discussion atom
- thread = discussion container
- issue = lifecycle-tracked review unit

Issue lifecycle and resolution must remain separate from approval truth.
