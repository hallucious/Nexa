...
`docs/specs/ui/workspace_shell/13_interaction_contract.md`

## 1. Purpose

This document fixes the operational contract for click / double click / drag / hover / keyboard semantics inside the Nexa shell.
...
## 8. Canonical gesture family

- single click = select
- double click = open / deepen
- hover = explain / preview
- drag node = layout move
- drag from connector = propose connection
- context menu = bounded action menu

All interaction must be interpreted as intent emission, never raw mutation.
