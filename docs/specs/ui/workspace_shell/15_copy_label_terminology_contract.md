# Copy / Label / Terminology Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/15_copy_label_terminology_contract.md`

## 1. Purpose

This document fixes the operational contract for UI terms and labels inside the Nexa shell.
...
Helpful descriptions may be added, but canonical terms must not be replaced by fuzzy friendly substitutes.
