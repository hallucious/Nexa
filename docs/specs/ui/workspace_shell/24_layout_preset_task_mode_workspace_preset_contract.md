# Layout Preset / Task-Mode Workspace Preset Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/24_layout_preset_task_mode_workspace_preset_contract.md`

## 1. Purpose

This document fixes the operational contract for layout and task presets inside the Nexa shell.
...
Two kinds of presets are canonical:
- layout presets
- task-mode workspace presets
