# Notification / Toast / Banner Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/17_notification_toast_banner_contract.md`

## 1. Purpose

This document fixes the operational contract for signal channels inside the Nexa shell.
...
Four tiers are canonical:
- global banner
- inline banner
- toast
- passive badge / pulse

Strong signals are reserved for strong conditions like blocked, proposal blocked, run failed, or approval required.
