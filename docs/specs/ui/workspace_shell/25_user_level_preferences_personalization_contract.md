# User-Level Preferences / Personalization Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/25_user_level_preferences_personalization_contract.md`

## 1. Purpose

This document fixes the operational contract for user prefs vs workspace continuity inside the Nexa shell.
...
Three storage layers must stay distinct:
- user-level preference
- workspace continuity
- session-local ephemeral state

Personalization may affect presentation and ergonomics, but never structural, approval, execution, or storage truth.
