# Approval Decision Record / Reviewer Authority Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/29_approval_decision_record_reviewer_authority_contract.md`

## 1. Purpose

This document fixes the operational contract for approval truth and authority inside the Nexa shell.
...
## 8. Four-way separation

- comment = opinion
- issue resolution = discussion outcome
- approval decision = formal judgment
- commit = actual boundary crossing

Approval must carry actor, scope, target, basis, and authority.
Nothing else may impersonate approval.
