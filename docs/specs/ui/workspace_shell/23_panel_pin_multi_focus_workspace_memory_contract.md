# Panel Pin / Multi-Focus / Workspace Memory Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/23_panel_pin_multi_focus_workspace_memory_contract.md`

## 1. Purpose

This document fixes the operational contract for pinning, multiple context, restore inside the Nexa shell.
...
- pin = protect focus from automatic replacement
- multi-focus = keep bounded secondary contexts visible
- workspace memory = restore UI continuity, not engine truth

Responsive tiers may reinterpret pin as restore priority rather than always-visible permanence.
