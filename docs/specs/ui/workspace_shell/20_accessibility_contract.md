...
`docs/specs/ui/workspace_shell/20_accessibility_contract.md`

## 1. Purpose

This document fixes the operational contract for keyboard, screen reader, visual, motor, cognitive accessibility inside the Nexa shell.
...
## 8. Accessibility axes

Accessibility must be treated across:
...
Graph-centered UI still requires linear, list-based, and text-based alternative paths.
