# Shell Navigation Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/12_shell_navigation_contract.md`

## 1. Purpose

This document fixes the operational contract for Top Bar / Left Rail / Right Stack / Bottom Dock movement rules inside the Nexa shell.
...
Every navigation action must ultimately resolve into one of three shell effects:
- graph focus
- right-stack detail focus
- bottom-dock evidence focus

The graph is always the navigation anchor.
Panels move focus, not truth.
