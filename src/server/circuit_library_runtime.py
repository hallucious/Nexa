        ...
        item_sections.append(
            {
                ...
                "section": build_shell_section(
                    ...
                    detail_items=[
                        ...
                        ui_text("server.library.continue_route", app_language=app_language, fallback_text="You can continue this workflow from the product surface."),
                        ui_text("server.library.result_history_route", app_language=app_language, fallback_text="Recent result history is available from the product surface.") if item.result_history_href else None,
                    ],
