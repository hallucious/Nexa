...
from src.server.source_artifact_projection import project_source_artifact_view
...
def _source_artifact_view_from_sources(
    run_record_row: Mapping[str, Any] | None,
    *,
    metrics: Mapping[str, Any] | None = None,
) -> ProductSourceArtifactView | None:
    return project_source_artifact_view(run_record_row, metrics=metrics)
        ...
        if status == 'unknown' and not run_record_row.get('status') and engine_status is None:
            return RunStatusReadOutcome(
                response=ProductRunStatusResponse(
                    ...
                    last_action=latest_action_from_run_record(run_record_row),
...
class RunResultReadService:
    ...
    def _response_from_engine_envelope(
        ...
        *,
        ...
        return ProductRunResultResponse(
            ...
            source_artifact=_source_artifact_view_from_sources(None, metrics=envelope.metrics),
    ...
    def _response_from_rows(
        ...
        *,
        ...
        run_record_row: Mapping[str, Any] | None = None,
        updated_at: Optional[str],
        workspace_title: Optional[str] = None,
        provider_continuity=None,
        activity_continuity=None,
        ...
        return ProductRunResultResponse(
            ...
            final_output=final_output,
            source_artifact=_source_artifact_view_from_sources(run_record_row, metrics=result_row.get('metrics') if isinstance(result_row.get('metrics'), Mapping) else None),
    ...
    def read_result(
        ...
        *,
        ...
        if engine_result is not None:
            return RunResultReadOutcome(response=cls._response_from_engine_envelope(workspace_id=run_context.workspace_context.workspace_id, updated_at=updated_at, envelope=engine_result, workspace_title=workspace_title, provider_continuity=provider_continuity, activity_continuity=activity_continuity, actions=actions, last_action=latest_action_from_run_record(run_record_row)))
