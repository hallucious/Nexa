...
_RESPONSE_CONTRACT_BY_ROUTE_NAME: dict[str, dict[str, object]] = {
    ...
    "get_public_share_compare_summary": {"response_shape": "public-share-compare-summary", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("share_id", "compare", "status", "identity_policy", "namespace_policy")},
