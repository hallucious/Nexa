...
from src.contracts.nex_contract import (
    ...
    PublicNexShareHistoryBoundary,
    PublicNexShareHistoryEntryBoundary,
    PublicNexShareOperationBoundary,
    ShareAuditEventType,
    ShareLifecycleState,
    ShareOperation,
)
...
_PUBLIC_NEX_SHARE_BOUNDARY = PublicNexShareBoundary(
    ...
    public_access_posture="anonymous_readonly",
    management_access_posture="issuer_authenticated_lifecycle_management",
    history_access_posture="public_audit_history",
    artifact_access_posture="capability_bounded_artifact_access",
    ...
    public_operation_boundaries=(
        PublicNexShareOperationBoundary(
            ...
            posture="anonymous_public_metadata_read",
            canonical_http_method="GET",
            canonical_route="/api/public-shares/{share_id}",
            result_surface="public_share_detail",
            effect_posture="read_only",
            requires_authentication=False,
            requires_issuer_scope=False,
            lifecycle_gate="available_while_share_resolves",
            allowed_storage_roles=("working_save", "commit_snapshot"),
            allowed_effective_lifecycle_states=("active", "expired", "revoked"),
            denial_reason_code="public_share.metadata_not_allowed",
        ),
        PublicNexShareOperationBoundary(
            operation="download_artifact",
            posture="anonymous_capability_bounded_artifact_download",
            canonical_http_method="GET",
            ...
            requires_authentication=False,
            requires_issuer_scope=False,
            lifecycle_gate="blocked_after_terminal_state",
            allowed_storage_roles=("working_save", "commit_snapshot"),
            allowed_effective_lifecycle_states=("active",),
            denial_reason_code="public_share.download_not_allowed",
        ),
        PublicNexShareOperationBoundary(
            operation="import_copy",
            posture="anonymous_public_import_copy",
            canonical_http_method="GET",
            canonical_route="/api/public-shares/{share_id}/artifact",
            result_surface="public_share_artifact",
            effect_posture="copy_into_new_local_context",
            requires_authentication=False,
            requires_issuer_scope=False,
            lifecycle_gate="blocked_after_terminal_state",
            allowed_storage_roles=("working_save", "commit_snapshot"),
            allowed_effective_lifecycle_states=("active",),
            denial_reason_code="public_share.import_not_allowed",
        ),
        PublicNexShareOperationBoundary(
            operation="run_artifact",
            posture="anonymous_capability_bounded_run",
            canonical_http_method="GET",
            canonical_route="/api/public-shares/{share_id}/artifact",
            result_surface="public_share_artifact",
            effect_posture="run_without_mutating_shared_source",
            requires_authentication=False,
            requires_issuer_scope=False,
            lifecycle_gate="role_and_capability_bounded",
            allowed_storage_roles=("working_save", "commit_snapshot"),
            allowed_effective_lifecycle_states=("active",),
            denial_reason_code="public_share.run_not_allowed",
        ),
        PublicNexShareOperationBoundary(
            operation="checkout_working_copy",
            posture="anonymous_commit_snapshot_checkout_only",
            canonical_http_method="GET",
            canonical_route="/api/public-shares/{share_id}/artifact",
            result_surface="public_share_artifact",
            effect_posture="derive_new_working_copy_without_mutating_shared_source",
            requires_authentication=False,
            requires_issuer_scope=False,
            lifecycle_gate="commit_snapshot_only_and_blocked_after_terminal_state",
            allowed_storage_roles=("commit_snapshot",),
            allowed_effective_lifecycle_states=("active",),
            denial_reason_code="public_share.checkout_not_allowed",
        ),
    ),
    management_operation_boundaries=(
        PublicNexShareOperationBoundary(
            operation="revoke",
            posture="issuer_authenticated_lifecycle_management",
            canonical_http_method="POST",
            canonical_route="/api/public-shares/{share_id}/revoke",
            result_surface="single_share_mutation_result",
            effect_posture="lifecycle_transition",
            requires_authentication=True,
            requires_issuer_scope=True,
            lifecycle_gate="active_only",
            allowed_storage_roles=("working_save", "commit_snapshot"),
            allowed_effective_lifecycle_states=("active",),
            denial_reason_code="public_share.transition_not_allowed",
        ),
        PublicNexShareOperationBoundary(
            operation="extend_expiration",
            posture="issuer_authenticated_lifecycle_management",
            canonical_http_method="POST",
            canonical_route="/api/public-shares/{share_id}/extend",
            result_surface="single_share_mutation_result",
            effect_posture="lifecycle_extension",
            requires_authentication=True,
            requires_issuer_scope=True,
            lifecycle_gate="active_only",
            allowed_storage_roles=("working_save", "commit_snapshot"),
        ...
        PublicNexShareOperationBoundary(
            operation="delete",
            posture="issuer_authenticated_lifecycle_management",
            canonical_http_method="DELETE",
            canonical_route="/api/public-shares/{share_id}",
            result_surface="single_share_mutation_result",
            effect_posture="destructive_removal",
            requires_authentication=True,
            requires_issuer_scope=True,
            lifecycle_gate="issuer_scope_required",
            allowed_storage_roles=("working_save", "commit_snapshot"),
            allowed_effective_lifecycle_states=("active", "expired", "revoked"),
            denial_reason_code="public_share.management_not_allowed",
        ),
        PublicNexShareOperationBoundary(
            operation="archive",
            posture="issuer_authenticated_lifecycle_management",
            canonical_http_method="POST",
            canonical_route="/api/public-shares/{share_id}/archive",
            result_surface="single_share_mutation_result",
            effect_posture="visibility_state_change",
            requires_authentication=True,
            requires_issuer_scope=True,
            lifecycle_gate="issuer_scope_required",
            allowed_storage_roles=("working_save", "commit_snapshot"),
    ...
    history_boundary=PublicNexShareHistoryBoundary(
        access_posture="public_audit_history",
        ordering="ascending_sequence",
        canonical_http_method="GET",
        canonical_route="/api/public-shares/{share_id}/history",
        result_surface="public_share_history",
        actor_identity_posture="optional_actor_user_ref",
        event_types=_ALLOWED_AUDIT_EVENT_TYPES,
        includes_stored_lifecycle_state=True,
        includes_effective_lifecycle_state=True,
        detail_payload_posture="optional_string_map",
        entry_boundary=PublicNexShareHistoryEntryBoundary(
            entry_surface="public_share_audit_entry",
            identity_field="sequence",
            timestamp_field="at",
            event_type_field="event_type",
            actor_identity_field="actor_user_ref",
            stored_lifecycle_field="stored_lifecycle_state",
            effective_lifecycle_field="effective_lifecycle_state",
            detail_payload_field="details",
            detail_payload_value_posture="string_map_when_present",
        ),
    ),
