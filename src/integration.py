...
@dataclass(frozen=True)
class PublicCommunityExportSurfaceSummary:
    discovery_routes: Mapping[str, str]
    public_sdk_entrypoints: Mapping[str, str]
    ...
    *,
    ...
    return PublicEcosystemExportSurfaceSummary(
        ...
        public_sdk_entrypoints={
            ...
            "mcp_export_summary": "describe_public_mcp_export_surface",
            "plugin_catalog_summary": "describe_public_plugin_export_surface",
            "community_catalog_summary": "describe_public_community_export_surface",
...
def describe_public_plugin_export_surface() -> PublicPluginExportSurfaceSummary:
    ...
    return PublicPluginExportSurfaceSummary(
        discovery_routes={
            ...
            "public_sdk_catalog": api_route("public_sdk_catalog"),
            "public_ecosystem_catalog": api_route("public_ecosystem_catalog"),
...
def describe_public_community_export_surface() -> PublicCommunityExportSurfaceSummary:
    """Return the public community-facing asset catalog summary."""

    share_boundary = get_public_nex_share_boundary()
    starter_templates = list_starter_circuit_templates()
    plugin_summary = describe_public_plugin_export_surface()
    asset_families = PUBLIC_COMMUNITY_ASSET_SURFACE_FAMILIES
    return PublicCommunityExportSurfaceSummary(
        discovery_routes={
            ...
            "public_share_catalog_summary": api_route("public_share_catalog_summary"),
            "starter_template_catalog": api_route("starter_template_catalog"),
        },
        public_sdk_entrypoints={
            "community_catalog_summary": "describe_public_community_export_surface",
            "plugin_catalog_summary": "describe_public_plugin_export_surface",
...
_FRAMEWORK_HANDLER_BY_ROUTE_NAME: dict[str, str] = {
    ...
    "get_public_community_catalog": "handle_public_community_catalog",
    ...
    "create_workspace_public_share": "handle_create_workspace_public_share",
    ...
    "get_public_share_issuer_catalog_summary": "handle_get_public_share_issuer_catalog_summary",
    "list_saved_public_shares": "handle_list_saved_public_shares",
    ...
    "checkout_public_share": "handle_checkout_public_share",
    "import_public_share": "handle_import_public_share",
    "create_workspace_from_public_share": "handle_create_workspace_from_public_share",
    "run_public_share": "handle_run_public_share",
...
_ARGUMENT_SCHEMA_BY_ROUTE_NAME: dict[str, dict[str, object]] = {
    ...
    "create_workspace_public_share": {
        "path_fields": (_schema_field("workspace_id", "path", "string", required=True, description="Workspace whose artifact lineage should be shared publicly."),),
        "body_fields": (
            _schema_field("share_id", "body", "string", description="Optional explicit public share identifier."),
            _schema_field("title", "body", "string", description="Optional public share title."),
            _schema_field("summary", "body", "string", description="Optional public share summary."),
    ...
    "list_public_shares": {
        "query_fields": (
            ...
            _schema_field("operation", "query", "string", description="Optional capability filter."),
        ),
    },
    "get_public_share_catalog_summary": {
        "query_fields": (
            _schema_field("q", "query", "string", description="Optional text search for catalog summary scope."),
            _schema_field("storage_role", "query", "string", description="Optional storage role filter."),
            _schema_field("operation", "query", "string", description="Optional capability filter."),
        ),
    },
    "list_public_shares_by_issuer": {
        "path_fields": (_schema_field("issuer_user_ref", "path", "string", required=True, description="Issuer whose public shares should be listed."),),
        "query_fields": (
            _schema_field("q", "query", "string", description="Optional text search for issuer catalog entries."),
            _schema_field("storage_role", "query", "string", description="Optional storage role filter."),
            _schema_field("operation", "query", "string", description="Optional capability filter."),
        ),
    },
    "get_public_share_issuer_catalog_summary": {
        "path_fields": (_schema_field("issuer_user_ref", "path", "string", required=True, description="Issuer whose public share catalog summary should be read."),),
        "query_fields": (
            _schema_field("q", "query", "string", description="Optional text search for issuer catalog summary scope."),
            _schema_field("storage_role", "query", "string", description="Optional storage role filter."),
            _schema_field("operation", "query", "string", description="Optional capability filter."),
        ),
    },
    "list_saved_public_shares": {
        "query_fields": (_schema_field("app_language", "query", "string", description="Optional app language for saved-share views."),),
    },
    "save_public_share": {
        "path_fields": (_schema_field("share_id", "path", "string", required=True, description="Public share to save into the authenticated user's saved collection."),),
    },
    "unsave_public_share": {
        "path_fields": (_schema_field("share_id", "path", "string", required=True, description="Public share to remove from the authenticated user's saved collection."),),
    },
    ...
    "checkout_public_share": {
        "path_fields": (_schema_field("share_id", "path", "string", required=True, description="Public share to restore into an existing workspace."),),
        "body_fields": (
            _schema_field("workspace_id", "body", "string", required=True, description="Workspace that should receive the restored working copy."),
            _schema_field("working_save_id", "body", "string", description="Optional working_save identifier to assign during checkout."),
        ),
    },
    "import_public_share": {
        "path_fields": (_schema_field("share_id", "path", "string", required=True, description="Public share to import into an existing workspace."),),
        "body_fields": (
            _schema_field("workspace_id", "body", "string", required=True, description="Workspace that should receive the imported artifact."),
        ),
    },
    "create_workspace_from_public_share": {
        "path_fields": (_schema_field("share_id", "path", "string", required=True, description="Public share that should seed a newly created workspace."),),
        "body_fields": (
            _schema_field("title", "body", "string", description="Optional workspace title override."),
            _schema_field("description", "body", "string", description="Optional workspace description override."),
            _schema_field("create_mode", "body", "string", description="Optional preferred create mode such as checkout_working_copy or import_copy."),
            _schema_field("working_save_id", "body", "string", description="Optional working_save identifier used when checkout_working_copy is selected."),
        ),
    },
    "run_public_share": {
        "path_fields": (_schema_field("share_id", "path", "string", required=True, description="Public share whose artifact should be launched."),),
        "body_fields": (
            _schema_field("workspace_id", "body", "string", required=True, description="Workspace context used to launch the shared artifact."),
            _schema_field("input_payload", "body", "object", description="Optional launch input payload."),
        ),
    },
    "extend_public_share": {
    ...
    "list_workspace_starter_circuit_templates": {
        "path_fields": (_schema_field("workspace_id", "path", "string", required=True, description="Workspace whose starter-template catalog should be read."),),
        "query_fields": (
            _schema_field("app_language", "query", "string", description="Optional language hint for localized workspace starter-template catalog summaries."),
        ),
    },
    "get_workspace_starter_circuit_template": {
        "path_fields": (
            _schema_field("workspace_id", "path", "string", required=True, description="Workspace whose starter-template detail should be read."),
            _schema_field("template_id", "path", "string", required=True, description="Starter template lookup value to read inside the workspace-scoped starter-template surface. Accepts a legacy template_id or canonical template_ref."),
        ),
        "query_fields": (
            _schema_field("app_language", "query", "string", description="Optional language hint for localized workspace starter-template detail."),
        ),
    },
...
_ROUTE_CONTRACT_BY_ROUTE_NAME: dict[str, dict[str, str]] = {
    ...
    "list_workspace_starter_circuit_templates": {"route_family": "workspace-starter-template-catalog-read", "transport_profile": "path-and-query"},
    "get_workspace_starter_circuit_template": {"route_family": "workspace-starter-template-detail-read", "transport_profile": "path-and-query"},
    ...
    "create_workspace_public_share": {"route_family": "workspace-public-share-create", "transport_profile": "path-and-body"},
    ...
    "get_public_share_issuer_catalog_summary": {"route_family": "public-share-issuer-catalog-summary", "transport_profile": "path-and-query"},
    "list_saved_public_shares": {"route_family": "saved-public-share-collection", "transport_profile": "query-only"},
    ...
    "checkout_public_share": {"route_family": "public-share-checkout", "transport_profile": "path-and-body"},
    "import_public_share": {"route_family": "public-share-import", "transport_profile": "path-and-body"},
    "create_workspace_from_public_share": {"route_family": "public-share-create-workspace", "transport_profile": "path-and-body"},
    "run_public_share": {"route_family": "public-share-run", "transport_profile": "path-and-body"},
    ...
    "get_public_community_catalog": {"route_family": "public-community-catalog-read", "transport_profile": "no-arguments"},
...
_RECOVERY_POLICY_BY_ROUTE_FAMILY: dict[str, dict[str, object]] = {
    ...
    "workspace-starter-template-catalog-read": {
        "idempotency_class": "read-only",
        "timeout_retryable": True,
        "safe_to_retry_same_request_on_timeout": True,
        "timeout_recommended_action": "retry_same_request",
    ...
    "workspace-starter-template-detail-read": {
        "idempotency_class": "read-only",
        "timeout_retryable": True,
        "safe_to_retry_same_request_on_timeout": True,
        "timeout_recommended_action": "retry_same_request",
    ...
    "public-share-issuer-catalog-summary": {
        "idempotency_class": "read-only",
        "timeout_retryable": True,
        "safe_to_retry_same_request_on_timeout": True,
        "timeout_recommended_action": "retry_same_request",
...
_LIFECYCLE_CONTROL_BY_ROUTE_FAMILY: dict[str, dict[str, object]] = {
    ...
    "workspace-starter-template-catalog-read": {
        "lifecycle_class": "workspace-starter-template-catalog-read",
        "result_resource_name": "list_workspace_starter_circuit_templates",
        "followup_route_names": ("list_workspace_starter_circuit_templates", "get_workspace_starter_circuit_template", "apply_starter_circuit_template", "get_workspace_shell", "get_workspace_feedback", "get_circuit_library"),
    },
    "workspace-starter-template-detail-read": {
        "lifecycle_class": "workspace-starter-template-detail-read",
        "result_resource_name": "get_workspace_starter_circuit_template",
        "followup_route_names": ("get_workspace_starter_circuit_template", "apply_starter_circuit_template", "list_workspace_starter_circuit_templates", "get_workspace_shell", "get_workspace_feedback", "put_workspace_shell_draft", "launch_workspace_shell"),
    },
    "starter-template-apply": {
    ...
    "public-plugin-catalog-read": {
        ...
        "followup_route_names": ("get_public_plugin_catalog", "get_public_community_catalog", "get_public_sdk_catalog", "get_public_ecosystem_catalog", "get_public_mcp_manifest"),
    },
    "public-community-catalog-read": {
        "lifecycle_class": "public-community-catalog-read",
        "result_resource_name": "get_public_community_catalog",
        "followup_route_names": ("get_public_community_catalog", "get_public_ecosystem_catalog", "get_public_plugin_catalog", "list_public_shares", "get_public_share_catalog_summary", "list_starter_circuit_templates"),
    },
    "public-mcp-manifest-read": {
    ...
    "workspace-public-share-history": {
        ...
        "followup_route_names": ("get_workspace_public_share_history", "get_workspace_public_share_create_context", "create_workspace_public_share", "get_workspace_shell"),
    },
    "workspace-public-share-create-context": {
        "lifecycle_class": "workspace-public-share-create-context",
        "result_resource_name": "get_workspace_public_share_create_context",
        "followup_route_names": ("get_workspace_public_share_create_context", "create_workspace_public_share", "get_workspace_public_share_history", "get_workspace_shell"),
    },
    "workspace-public-share-create": {
        "lifecycle_class": "workspace-public-share-create",
        "status_resource_name": "get_public_share",
        "followup_route_names": ("get_public_share", "get_workspace_public_share_history", "get_workspace_public_share_create_context", "get_workspace_shell"),
    },
    "public-share-catalog": {
        "lifecycle_class": "public-share-discovery",
        "followup_route_names": ("get_public_share", "get_public_share_catalog_summary", "list_saved_public_shares", "get_related_public_shares", "get_public_share_compare_summary"),
    },
    "public-share-catalog-summary": {
        "lifecycle_class": "public-share-discovery",
        "followup_route_names": ("list_public_shares", "list_saved_public_shares", "get_public_share"),
    },
    "public-share-issuer-catalog": {
        "lifecycle_class": "public-share-discovery",
        "followup_route_names": ("get_public_share", "get_public_share_issuer_catalog_summary", "list_public_shares", "list_saved_public_shares"),
    },
    "public-share-issuer-catalog-summary": {
        "lifecycle_class": "public-share-discovery",
        "followup_route_names": ("list_public_shares_by_issuer", "list_public_shares", "get_public_share"),
    },
    "saved-public-share-collection": {
        "lifecycle_class": "public-share-discovery",
        "followup_route_names": ("get_public_share", "get_public_share_compare_summary", "get_related_public_shares", "unsave_public_share"),
    },
    "saved-public-share-mutation": {
        "lifecycle_class": "saved-public-share-mutation",
        "status_resource_name": "list_saved_public_shares",
        "preferred_control_tool_names": ("save_public_share", "unsave_public_share"),
        "followup_route_names": ("list_saved_public_shares", "get_public_share"),
    },
    "public-share-related": {
        "lifecycle_class": "public-share-discovery",
        "status_resource_name": "get_public_share",
    ...
    "public-share-compare-summary": {
        ...
        "status_resource_name": "get_public_share",
        "result_resource_name": "get_public_share_artifact",
        "followup_route_names": ("get_public_share", "get_public_share_artifact", "get_related_public_shares"),
    },
    "public-share-create": {
    ...
    "workspace-public-share-create": {
        ...
        "result_resource_name": "get_public_share_artifact",
        "actions_resource_name": "get_public_share_history",
        "followup_route_names": ("get_public_share", "get_public_share_history", "get_public_share_artifact", "get_workspace_public_share_history", "get_workspace_public_share_create_context"),
    },
    "public-share-read": {
        ...
        "result_resource_name": "get_public_share_artifact",
        "actions_resource_name": "get_public_share_history",
        "preferred_control_tool_names": ("save_public_share", "unsave_public_share", "checkout_public_share", "import_public_share", "create_workspace_from_public_share", "run_public_share"),
        "followup_route_names": ("list_saved_public_shares", "get_public_share_history", "get_public_share_artifact", "save_public_share", "unsave_public_share", "checkout_public_share", "import_public_share", "create_workspace_from_public_share", "run_public_share"),
    },
    "public-share-history": {
    ...
    "public-share-checkout": {
        "lifecycle_class": "public-share-consumer-action",
        "status_resource_name": "get_public_share",
        "result_resource_name": "get_workspace_shell",
        "followup_route_names": ("get_public_share", "get_workspace", "get_workspace_shell"),
    },
    "public-share-import": {
        "lifecycle_class": "public-share-consumer-action",
        "status_resource_name": "get_public_share",
        "result_resource_name": "get_workspace",
        "followup_route_names": ("get_public_share", "get_workspace", "get_workspace_shell"),
    },
    "public-share-create-workspace": {
        "lifecycle_class": "public-share-consumer-action",
    ...
    "public-share-run": {
        "lifecycle_class": "public-share-consumer-run",
        "status_resource_name": "get_public_share",
        "result_resource_name": "get_run_status",
        "actions_resource_name": "get_run_actions",
        "followup_route_names": ("get_public_share", "get_run_status", "get_run_result", "list_run_artifacts"),
    },
    "public-share-management": {
...
_RESULT_SHAPE_PROFILE_BY_ROUTE_NAME: dict[str, dict[str, object]] = {
    ...
    "retry_run": {
        ...
        "identity_keys": ("run_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "force_reset_run": {
        "profile_kind": "run-control-status",
    ...
    "list_workspace_runs": {
        ...
        "collection_item_identity_keys": ("run_id", "identity"),
    },
    "get_run_trace": {
        ...
        "collection_item_identity_keys": ("event_id", "identity"),
    },
    "list_run_artifacts": {
        ...
        "collection_item_identity_keys": ("artifact_id", "identity"),
    },
    "get_artifact_detail": {
        "profile_kind": "artifact-detail",
        "identity_keys": ("artifact_id", "identity_policy", "namespace_policy"),
    },
    "get_run_actions": {
    ...
    "list_workspace_starter_circuit_templates": {
        "profile_kind": "workspace-starter-template-catalog",
        "identity_keys": ("workspace_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status", "app_language"),
        "collection_field_name": "templates",
        "collection_item_identity_keys": ("template_ref", "template_id"),
    ...
    "get_workspace_starter_circuit_template": {
        "profile_kind": "workspace-starter-template-detail",
        "identity_keys": ("workspace_id", "template.template_ref", "template.template_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status", "app_language"),
    },
    "get_public_nex_format": {
    ...
    "get_public_community_catalog": {
        "profile_kind": "public-community-catalog",
        "identity_keys": ("catalog", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
        "collection_field_name": "assets",
        "collection_item_identity_keys": ("asset_family", "surface_family"),
    },
    "get_public_mcp_manifest": {
        ...
        "collection_field_name": "manifest.tools",
    ...
    "get_public_mcp_host_bridge": {
        ...
        "collection_field_name": "host_bridge.tool_bindings",
        "collection_item_identity_keys": ("route_name",),
    },
    "get_workspace_result_history": {
    ...
    "get_provider_catalog": {
        ...
        "count_field_name": "returned_count",
        "collection_item_identity_keys": ("provider_key", "identity"),
    },
    "list_workspace_provider_bindings": {
        ...
        "count_field_name": "returned_count",
        "collection_item_identity_keys": ("binding_id", "identity"),
    },
    "put_workspace_provider_binding": {
        "profile_kind": "workspace-provider-binding-write",
        "identity_keys": ("binding.binding_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "list_workspace_provider_health": {
    ...
    "get_workspace_provider_health": {
        ...
        "identity_keys": ("workspace_id", "provider_key", "identity_policy", "namespace_policy"),
    },
    "probe_workspace_provider": {
    ...
    "list_provider_probe_history": {
        ...
        "count_field_name": "returned_count",
        "collection_item_identity_keys": ("probe_event_id", "identity"),
    },
    "get_onboarding": {
    ...
    "get_public_share_catalog_summary": {
        "profile_kind": "public-share-catalog-summary",
        "identity_keys": ("identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "list_public_shares_by_issuer": {
        "profile_kind": "public-share-issuer-catalog-collection",
    ...
    "get_public_share_issuer_catalog_summary": {
        "profile_kind": "public-share-issuer-catalog-summary",
        "identity_keys": ("issuer_user_ref", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "list_saved_public_shares": {
        "profile_kind": "saved-public-share-collection",
        "identity_keys": ("saved_by_user_ref", "identity_policy", "namespace_policy"),
        "collection_field_name": "shares",
        "count_field_name": "returned_count",
        "collection_item_identity_keys": ("share_id", "identity"),
    },
    "save_public_share": {
        "profile_kind": "saved-public-share-mutation",
        "identity_keys": ("share_id", "saved_by_user_ref", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "unsave_public_share": {
        "profile_kind": "saved-public-share-mutation",
    ...
    "get_related_public_shares": {
        "profile_kind": "related-public-share-collection",
        "identity_keys": ("share_id", "identity", "identity_policy", "namespace_policy"),
        "collection_field_name": "shares",
    ...
    "checkout_public_share": {
        "profile_kind": "public-share-checkout",
        "identity_keys": ("share_id", "workspace_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "import_public_share": {
        "profile_kind": "public-share-import",
        "identity_keys": ("share_id", "workspace_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "create_workspace_from_public_share": {
        "profile_kind": "public-share-create-workspace",
        "identity_keys": ("share_id", "workspace_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "run_public_share": {
        "profile_kind": "public-share-run",
        "identity_keys": ("share_id", "workspace_id", "run_id", "identity_policy", "namespace_policy"),
        "state_keys": ("status",),
    },
    "extend_public_share": {
...
_RESPONSE_CONTRACT_BY_ROUTE_NAME: dict[str, dict[str, object]] = {
    ...
    "mark_run_reviewed": {"response_shape": "run-control", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("status", "run_id", "identity_policy", "namespace_policy")},
    "get_run_status": {"response_shape": "status", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("run_id", "status", "identity_policy", "namespace_policy")},
    "get_run_result": {"response_shape": "result", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("run_id", "result_state", "identity_policy", "namespace_policy")},
    "list_workspace_runs": {"response_shape": "list", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("workspace_id", "returned_count", "runs", "identity_policy", "namespace_policy")},
    "get_run_trace": {"response_shape": "trace", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("run_id", "status", "events", "identity_policy", "namespace_policy")},
    "list_run_artifacts": {"response_shape": "list", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("run_id", "workspace_id", "artifact_count", "artifacts", "identity_policy", "namespace_policy")},
    "get_artifact_detail": {"response_shape": "detail", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("artifact_id", "run_id", "workspace_id", "kind", "identity_policy", "namespace_policy")},
    "get_run_actions": {"response_shape": "action-log", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("run_id", "workspace_id", "returned_count", "actions", "identity_policy", "namespace_policy")},
    ...
    "get_public_community_catalog": {"response_shape": "public-community-catalog", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("status", "catalog", "assets", "public_sdk_entrypoints", "identity_policy", "namespace_policy", "routes")},
    "get_public_mcp_manifest": {
    ...
    "get_public_mcp_host_bridge": {
        "response_shape": "public-mcp-host-bridge",
        "success_status_codes": (200,),
        "body_kind": "object",
        "required_top_level_keys": (
            "status",
    ...
    "get_provider_catalog": {"response_shape": "provider-catalog", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("returned_count", "providers", "identity_policy", "namespace_policy")},
    "list_workspace_provider_bindings": {"response_shape": "workspace-provider-binding-list", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("workspace_id", "returned_count", "bindings", "identity_policy", "namespace_policy")},
    "put_workspace_provider_binding": {"response_shape": "workspace-provider-binding-write", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("status", "binding", "was_created", "secret_rotated", "identity_policy", "namespace_policy")},
    "list_workspace_provider_health": {"response_shape": "workspace-provider-health-list", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("workspace_id", "returned_count", "providers", "identity_policy", "namespace_policy")},
    "get_workspace_provider_health": {"response_shape": "workspace-provider-health-detail", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("workspace_id", "health", "identity_policy", "namespace_policy")},
    "probe_workspace_provider": {"response_shape": "workspace-provider-probe", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("workspace_id", "provider_key", "probe_status", "connectivity_state", "findings", "links", "identity_policy", "namespace_policy")},
    "list_provider_probe_history": {"response_shape": "workspace-provider-probe-history", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("workspace_id", "provider_key", "returned_count", "total_visible_count", "items", "applied_filters", "identity_policy", "namespace_policy")},
    ...
    "create_workspace_public_share": {"response_shape": "public-share-created", "success_status_codes": (201,), "body_kind": "object", "required_top_level_keys": ("share_id", "status", "identity_policy", "namespace_policy")},
    ...
    "get_public_share_issuer_catalog_summary": {"response_shape": "public-share-issuer-catalog-summary", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "summary", "status", "identity_policy", "namespace_policy")},
    "list_saved_public_shares": {"response_shape": "saved-public-share-collection", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("saved_by_user_ref", "returned_count", "shares", "status", "identity_policy", "namespace_policy")},
    ...
    "checkout_public_share": {"response_shape": "public-share-checkout", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("share_id", "workspace_id", "working_save_id", "status", "action", "identity_policy", "namespace_policy")},
    "import_public_share": {"response_shape": "public-share-import", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("share_id", "workspace_id", "storage_role", "status", "action", "identity_policy", "namespace_policy")},
    "create_workspace_from_public_share": {"response_shape": "public-share-create-workspace", "success_status_codes": (201,), "body_kind": "object", "required_top_level_keys": ("share_id", "workspace_id", "create_mode", "storage_role", "status", "action", "identity_policy", "namespace_policy")},
    "run_public_share": {"response_shape": "public-share-run", "success_status_codes": (202,), "body_kind": "object", "required_top_level_keys": ("share_id", "workspace_id", "run_id", "target_type", "target_ref", "status", "action", "identity_policy", "namespace_policy")},
    ...
    "list_issuer_public_shares": {"response_shape": "issuer-public-share-list", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "shares", "management_capability_summary", "bulk_action_availability", "status", "identity_policy", "namespace_policy")},
    "get_issuer_public_share_summary": {"response_shape": "issuer-public-share-summary", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "summary", "management_capability_summary", "bulk_action_availability", "status", "identity_policy", "namespace_policy")},
    "list_issuer_public_share_action_reports": {"response_shape": "issuer-public-share-action-report-list", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "reports", "management_capability_summary", "bulk_action_availability", "status", "identity_policy", "namespace_policy")},
    "get_issuer_public_share_action_report_summary": {"response_shape": "issuer-public-share-action-report-summary", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "summary", "management_capability_summary", "bulk_action_availability", "status", "identity_policy", "namespace_policy")},
    "revoke_issuer_public_shares": {"response_shape": "issuer-public-share-bulk-mutation", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "management_capability_summary", "bulk_action_availability", "status", "action", "identity_policy", "namespace_policy")},
    "extend_issuer_public_shares": {"response_shape": "issuer-public-share-bulk-mutation", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "management_capability_summary", "bulk_action_availability", "status", "action", "identity_policy", "namespace_policy")},
    "archive_issuer_public_shares": {"response_shape": "issuer-public-share-bulk-mutation", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "management_capability_summary", "bulk_action_availability", "status", "action", "identity_policy", "namespace_policy")},
    "delete_issuer_public_shares": {"response_shape": "issuer-public-share-bulk-mutation", "success_status_codes": (200,), "body_kind": "object", "required_top_level_keys": ("issuer_user_ref", "management_capability_summary", "bulk_action_availability", "status", "action", "identity_policy", "namespace_policy")},
...
_TOOL_SPECS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "description": "Create a public share for the current workspace shell artifact through the legacy shell-scoped route.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductWorkspaceShellShareCreatedResponse"),
        "tags": ("workspace-shell", "sharing", "legacy", "public-boundary"),
    },
    {
        "name": "create_workspace_public_share",
        "route_name": "create_workspace_public_share",
        "description": "Create a public share for the current workspace artifact through the workspace share family route.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductWorkspaceShellShareCreatedResponse"),
        "tags": ("workspace", "public-share", "create", "public-boundary"),
    },
    {
    ...
    {
        "name": "checkout_public_share",
        "route_name": "checkout_public_share",
        "description": "Restore a public share into an existing workspace as a working copy.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareCheckoutAcceptedResponse"),
        "tags": ("sharing", "public-boundary", "consumer-action"),
    },
    {
        "name": "import_public_share",
        "route_name": "import_public_share",
        "description": "Import a public share artifact into an existing workspace.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareImportAcceptedResponse"),
        "tags": ("sharing", "public-boundary", "consumer-action"),
    },
    {
        "name": "create_workspace_from_public_share",
        "route_name": "create_workspace_from_public_share",
        "description": "Create a new workspace directly from a public share artifact.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareCreateWorkspaceAcceptedResponse"),
        "tags": ("sharing", "public-boundary", "consumer-action"),
    },
    {
        "name": "run_public_share",
        "route_name": "run_public_share",
        "description": "Launch a run directly from a public share artifact in an existing workspace.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareRunAcceptedResponse"),
        "tags": ("sharing", "public-boundary", "consumer-action"),
    },
    {
        "name": "save_public_share",
        "route_name": "save_public_share",
        "description": "Save a public share into the current authenticated user's saved-share collection.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductSavedPublicShareMutationResponse"),
        "tags": ("sharing", "public-boundary", "saved-state"),
    },
    {
        "name": "unsave_public_share",
        "route_name": "unsave_public_share",
        "description": "Remove a public share from the current authenticated user's saved-share collection.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductSavedPublicShareMutationResponse"),
        "tags": ("sharing", "public-boundary", "saved-state"),
    },
    {
...
_RESOURCE_SPECS: tuple[dict[str, object], ...] = (
    ...
    {
        "name": "list_workspace_starter_circuit_templates",
        "route_name": "list_workspace_starter_circuit_templates",
        "description": "Read the workspace-scoped starter-template catalog aligned to a target workspace context.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductWorkspaceStarterTemplateCatalogResponse"),
        "tags": ("workspace", "templates", "catalog"),
    },
    {
        "name": "get_workspace_starter_circuit_template",
        "route_name": "get_workspace_starter_circuit_template",
        "description": "Read one workspace-scoped starter-template detail entry aligned to a target workspace context.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductWorkspaceStarterTemplateDetailResponse"),
        "tags": ("workspace", "templates", "detail"),
    },
    {
    ...
    {
        "name": "get_public_community_catalog",
        "route_name": "get_public_community_catalog",
        "description": "Read the official public community asset catalog spanning starter templates, public shares, and plugin discovery.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicCommunityCatalogResponse"),
        "tags": ("integration", "community", "catalog"),
    },
    {
    ...
    },
    {
        ...
        "description": "List active public shares through the public discovery catalog surface.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareCatalogResponse"),
        "tags": ("public-share", "catalog", "list"),
    },
    {
        "name": "get_public_share_catalog_summary",
        "route_name": "get_public_share_catalog_summary",
        "description": "Read compact catalog summary counts for the public share discovery surface.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareCatalogSummaryResponse"),
        "tags": ("public-share", "catalog", "summary"),
    },
    {
        "name": "list_public_shares_by_issuer",
        "route_name": "list_public_shares_by_issuer",
        "description": "List active public shares for a specific issuer through the public discovery surface.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareIssuerCatalogResponse"),
        "tags": ("public-share", "issuer", "catalog"),
    },
    {
        "name": "get_public_share_issuer_catalog_summary",
        "route_name": "get_public_share_issuer_catalog_summary",
        "description": "Read compact public share catalog summary counts for a specific issuer.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareIssuerCatalogSummaryResponse"),
        "tags": ("public-share", "issuer", "summary"),
    },
    {
        "name": "list_saved_public_shares",
        "route_name": "list_saved_public_shares",
        "description": "List saved public shares for the current authenticated user.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductSavedPublicShareCollectionResponse"),
        "tags": ("public-share", "saved", "list"),
    },
    {
        "name": "get_related_public_shares",
    ...
    },
    {
        ...
        "description": "Read a bounded compare summary between a public share artifact and a workspace artifact.",
        "response_type": PublicTypeRef("src.sdk.server", "ProductPublicShareCompareSummaryResponse"),
        "tags": ("public-share", "compare", "summary"),
    },
    {
