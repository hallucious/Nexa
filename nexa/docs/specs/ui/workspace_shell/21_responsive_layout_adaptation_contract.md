# Responsive / Layout Adaptation Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/21_responsive_layout_adaptation_contract.md`

## 1. Purpose

This document fixes the operational contract for viewport tiers and adaptation inside the Nexa shell.
...
The shell should be interpreted across at least:
- wide desktop
- standard desktop / laptop
- narrow workspace / split view
- tablet / small touch workspace

Responsive behavior is not shrink-to-fit.
It is priority-based rearrangement.
