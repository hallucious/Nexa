# Command Palette / Quick Jump Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/18_command_palette_quick_jump_contract.md`

## 1. Purpose

This document fixes the operational contract for search+jump+action hub inside the Nexa shell.
...
The command palette is not just search.
It is a search + jump + action hub.

Results must route back into shell coordinates rather than floating as disconnected search output.
