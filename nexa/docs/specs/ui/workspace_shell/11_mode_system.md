...
`docs/specs/ui/workspace_shell/11_mode_system.md`

## 1. Purpose

This document fixes the operational contract for Build / Review / Run × Beginner / Advanced inside the Nexa shell.
...
The mode system is two-axis:

- task state: Build / Review / Run
- shell density: Beginner / Advanced

That produces six combinations:
- Build × Beginner
- Review × Beginner
- Run × Beginner
- Build × Advanced
...
They are different foreground configurations of the same shell.

## 9. Canonical defaults

- default entry: Build × Beginner
- proposal review: Review × Beginner
- first execution readout: Run × Beginner
- expert dense work: Build × Advanced or Run × Advanced
