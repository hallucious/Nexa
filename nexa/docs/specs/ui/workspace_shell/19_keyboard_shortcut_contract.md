# Keyboard Shortcut Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/19_keyboard_shortcut_contract.md`

## 1. Purpose

This document fixes the operational contract for global, mode, context shortcuts inside the Nexa shell.
...
Shortcuts must accelerate existing UI actions, not introduce secret mutation paths.
