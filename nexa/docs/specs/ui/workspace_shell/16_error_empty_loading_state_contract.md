# Error / Empty / Loading State Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/16_error_empty_loading_state_contract.md`

## 1. Purpose

This document fixes the operational contract for empty, loading, failure states inside the Nexa shell.
...
Every state screen must answer:
