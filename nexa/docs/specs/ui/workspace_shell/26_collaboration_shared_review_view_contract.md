# Collaboration / Shared Review View Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/26_collaboration_shared_review_view_contract.md`

## 1. Purpose

This document fixes the operational contract for shared review boundaries inside the Nexa shell.
...
## 8. Shared review principle

Shared review is not "send my exact personalized screen to someone else."
It is:
truth ref + review context + standard shared review preset

Personal density, theme, and private workspace habits remain local.
