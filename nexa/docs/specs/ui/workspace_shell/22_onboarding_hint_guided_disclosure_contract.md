# Onboarding Hint / Guided Disclosure Contract v1

## Recommended save path
`docs/specs/ui/workspace_shell/22_onboarding_hint_guided_disclosure_contract.md`

## 1. Purpose

This document fixes the operational contract for when and how hints appear inside the Nexa shell.
...
- contextual hint
- inline explanatory affordance
- on-demand deep help

Hints must point to the next action, not become long lectures floating over the workspace.
