...
class NexaUIViewAdapter:
    ...
    def read_product_flow_journey_view_model(
        ...
        *,
        ...
        return read_product_flow_journey_view_model(
            source,
            validation_report=validation_report,
            execution_record=execution_record if execution_record is not None else self.latest_execution_record,
            session_state_card=session_state_card,
    ...
    def read_product_flow_handoff_view_model(
        ...
        *,
        ...
        return read_product_flow_handoff_view_model(
            source,
            validation_report=validation_report,
            execution_record=execution_record if execution_record is not None else self.latest_execution_record,
            session_state_card=session_state_card,
    ...
    def read_product_flow_e2e_path_view_model(
        ...
        *,
        ...
        return read_product_flow_e2e_path_view_model(
            source,
            validation_report=validation_report,
            execution_record=execution_record if execution_record is not None else self.latest_execution_record,
            session_state_card=session_state_card,
    ...
    def read_product_flow_transition_view_model(
        ...
        *,
        ...
        return read_product_flow_transition_view_model(
            source,
            validation_report=validation_report,
            execution_record=execution_record if execution_record is not None else self.latest_execution_record,
            session_state_card=session_state_card,
